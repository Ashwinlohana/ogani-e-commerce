    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                ...
                <li>Free Shipping for all Order of Rs.999</li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
            ...
            <div class="row">
                <div class="categories__slider owl-carousel">
                    ...
                    while ($data = mysqli_fetch_array($result)) {
                        ?>
                        <div class="col-lg-3">
                            <div class="categories__item set-bg" data-setbg="img/product/<?php echo $data[3]; ?>">
                                <h5><a href="#"><?php echo $data[5]; ?></a></h5>
                            </div>
                        </div>
                    <?php } ?>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            while ($data = mysqli_fetch_array($result)) {
                                ?>
                                <li data-filter=".<?php echo $data[0]; ?>"><?php echo $data[0]; ?></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
        ...
        FROM 
            products;";
                ...
                while ($data = mysqli_fetch_array($r)) {
                    ?>
                    <div class="col-lg-3 col-md-4 col-sm-6 mix <?php echo $data[4]; ?>">
                        <div class="featured__item">
                            <div class="featured__item__pic set-bg" data-setbg="img/product/<?php echo $data[2]; ?>">
                                <ul class="featured__item__pic__hover">
                                    <li>
                                        <form action="index.php" method="post">
                                            <input type="hidden" name="ID" value="<?php echo $data[5]; ?>">
                            ...
                            <div class="featured__item__text">
                                <h6><a href="#"><?php echo $data[0]; ?></a></h6>
                                <h5>Rs: <?php echo (number_format($data[6], 2)); ?></h5>
                            </div>
                        </div>
                    </div>
                <?php } ?>
                                ...
                                while ($data = mysqli_fetch_array($result)) {
                                    ...
                                    <a href="#" class="latest-product__item">
                                        <div class="latest-product__item__pic">
                                            <img src="img/product/<?php echo $data[3]; ?>" alt="">
                                        </div>
                            ...
                            ";
                                ...
                                while ($data = mysqli_fetch_array($result)) {
                                    ...
                                    <a href="#" class="latest-product__item">
                                        ...
                                        <div class="latest-product__item__text">
                                            <h6><?php echo $data[1]; ?></h6>
                                            <span>Rs<?php echo $data[2]; ?>.00</span>
                                        </div>
                                    </a>
                                <?php } ?>
                            </div>
