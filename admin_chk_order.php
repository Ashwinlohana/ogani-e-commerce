            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <li><a href="admin_front.php">Home</a></li>
                ...
                <div class="col-lg-9">
                    ...
                    if (isset($_SESSION['loggedin']) || $_SESSION['loggedin'] == true) {
                        ...
                        $query = "SELECT `first_name`,`last_name`, `email`,`phone`, `address`, `city`,`country`, `products_data`,`order_datetime` FROM orders";
                        $result = mysqli_query($con, $query);
                        if (mysqli_num_rows($result) > 0) {

                            echo "<table width = 100% border='1' >";
                            echo "<tr><th>Name</th><th>Phone</th><th>Email</th><th>Address</th><th>City</th><th>Country</th><th>Products</th><th>Date</th>";
