    ...
    <section class="checkout spad">
        <div class="container">
            <div class="checkout__form">
                ...
                <form action="cart_info.php" name="mainForm" method="POST">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul>
                                    ...
                                    if (mysqli_num_rows($cart_result) > 0) {
                                        while ($cart_row = mysqli_fetch_assoc($cart_result)) {
                                            ...
                                            ?>
                                            <li><?php echo $product_data['NAME']; ?> <span>$<?php echo $total_price; ?></span>
                                            </li>
                                            <?php
                                        }
                                    }
                                ...
                                <div class="checkout__order__total">Total <span>$<?php echo $x; ?></span>
                                </div>
